...
# 7.NINJA BONUS: complete the remove_from_front method

# 8.NINJA BONUS: complete the remove_from_back method

# 9.NINJA BONUS: complete the remove_val method

# 10.SENSEI BONUS: complete the insert_at method

# 11.SENSEI BONUS: consider and account for edge cases for all previous methods
